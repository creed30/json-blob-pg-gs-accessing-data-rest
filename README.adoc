...
This is a forked guide to demo how to configure a spring data repository to use
the jsonb data type with a database, see the latest commits in the commit history.
all changes will be made to the complete project folder
